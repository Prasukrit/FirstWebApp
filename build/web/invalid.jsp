<%-- 
    Document   : invalid
    Created on : Jun 1, 2014, 2:37:51 PM
    Author     : Prasukrit
--%>
...
<body  class="animated fadeInRight">
	<div class="container" style="background-color:#FAFAFA">
		...
		<div style="margin:auto;text-align:center">
			<h1 align="center">username / password ไม่ถูกต้องโปรดloginใหม่อีกครั้ง</h1>
			<a href="index.jsp"><div id="backbutton" class="animated swing">คลิกเพื่อกลับสู่หน้าหลัก</div></a>
		</div>
		</section>
	</div>
